...
plt.errorbar(energy, real_8255, yerr = real_8255_err, marker='o', linestyle='none', alpha = 0.75, label = "0.83 mm real", color='magenta', capsize=4, capthick=1)
plt.plot(energy, sim_8255, alpha = 0.75, label = "0.83 mm sim", color='darkmagenta')
plt.errorbar(energy, real_16510, yerr = real_16510_err, marker='o', linestyle='none', alpha = 0.75, label = "1.65 mm real", color='blue', capsize=4, capthick=1)
plt.plot(energy, sim_16510, alpha = 0.75, label = "1.65 mm sim", color='navy')
plt.legend(fontsize=16)
plt.xticks(fontsize=16)
plt.yticks(fontsize=16)
plt.xlabel("Energy (keV)", fontsize=16)
plt.ylabel("Transmission", fontsize=16)
plt.title("Transmission Comparisson Study For Aluminum", fontsize=16)
plt.show()
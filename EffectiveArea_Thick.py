...
data_50keV = np.loadtxt("/home/skyes/Geant4_MSFC/Geant4_Rango/Plots/ThicknessStudies/EffectiveArea_NaI_50keV_Thick.txt", delimiter=",", dtype=float)
data_100keV = np.loadtxt("/home/skyes/Geant4_MSFC/Geant4_Rango/Plots/ThicknessStudies/EffectiveArea_NaI_100keV_Thick.txt", delimiter=",", dtype=float)
data_500keV = np.loadtxt("/home/skyes/Geant4_MSFC/Geant4_Rango/Plots/ThicknessStudies/EffectiveArea_NaI_500keV_Thick.txt", delimiter=",", dtype=float)
data_1000keV = np.loadtxt("/home/skyes/Geant4_MSFC/Geant4_Rango/Plots/ThicknessStudies/EffectiveArea_NaI_1000keV_Thick.txt", delimiter=",", dtype=float)

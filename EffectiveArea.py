...
data_NaI_Tl = np.loadtxt("/home/skyes/Geant4_MSFC/Geant4_Rango/EffectiveArea_NaI_Tl_OP_100000.txt", delimiter=",", dtype=float)
...
# plt.plot(data_BGO[:,0], data_BGO[:,1], alpha = 0.6, color='purple', label="BGO", linewidth=2)

plt.xscale('log')
plt.legend(fontsize=16)
plt.xticks(fontsize=16)
plt.yticks(fontsize=16)
plt.title('Effective Area v.s. Energy For NaI_Tl With Optical Photons', fontsize=16)
